      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row gap-8 justify-center">
          ...
          <div className="text-center md:w-1/3">
            ...
            <p className="text-gray-700">Più di 500 cliente trattate.</p>
          </div>
          ...
          <div className="text-center md:w-1/3">
            ...
            <p className="text-gray-700">
              Utilizziamo solo i migliori sul mercato, per garantire risultati
              duraturi e sicuri.
            </p>
          </div>
          {/* Luogo */}
          <div className="text-center md:w-1/3">
            ...
            <p className="text-gray-700">
              Uscita 17 del Grande Raccordo Anulare. Tre minuti a piedi dalla
